...
def print_spiciest_foods(spicy_foods)
  ...
  spiciest_foods.map {|food| puts "#{food[:name]} (#{food[:cuisine]}) | Heat Level: #{'🌶' * food[:heat_level]}"}
end
...
def average_heat_level(spicy_foods)
  # your code here
  level_spicy = spicy_foods.map {|food| food[:heat_level]}

  level_spicy.sum / level_spicy.size
end
